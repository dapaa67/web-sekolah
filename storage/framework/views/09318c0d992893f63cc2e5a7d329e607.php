...
<?php $__env->startSection('title', 'Ekstrakurikuler - SMP Islam Parung'); ?>
...
<section class="py-5" style="background-color: #f8f9fa;">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $ekskul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow rounded-4 overflow-hidden">
                    <img src="<?php echo e(asset('storage/' . $item->gambar)); ?>" class="card-img-top" alt="<?php echo e($item->nama); ?>" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo e($item->nama); ?></h5>
                        <p class="card-text"><?php echo e($item->deskripsi); ?></p>
                        <div class="text-muted">
                            <i class="fas fa-clock me-1"></i> <?php echo e($item->jadwal); ?><br>
                            <i class="fas fa-map-marker-alt me-1"></i> <?php echo e($item->lokasi); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-sekolah\resources\views/ekstrakurikuler.blade.php ENDPATH**/ ?>