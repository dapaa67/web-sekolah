...
?>
<?php $__env->startSection('title', 'Kalender Akademik - SMP Islam Parung'); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="date-range"><?php echo e($agenda->tanggal); ?></td>
                        <td class="activity"><?php echo e($agenda->kegiatan); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-sekolah\resources\views/kalenderakademik.blade.php ENDPATH**/ ?>